  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-blue-900 to-[#0096fd] relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-16 flex-1 w-full relative z-10 flex flex-col items-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-center mb-8 text-primary animate-slide-up drop-shadow-lg">Sobre o PontoFino</h1>
        <div className="flex flex-col md:flex-row items-center gap-12 w-full animate-fade-in" style={{animationDelay: '0.2s', animationFillMode: 'both'}}>
          <div className="flex-1 flex justify-center">
            <svg className="w-40 h-40 md:w-56 md:h-56 animate-float-slow" fill="none" viewBox="0 0 180 180">
          ...
          <div className="flex-1 max-w-2xl">
            <p className="text-lg md:text-xl text-gray-200 mb-6 animate-fade-in" style={{animationDelay: '0.3s', animationFillMode: 'both'}}>
            ...
            <ul className="list-disc list-inside text-gray-100 text-lg space-y-3 animate-slide-up" style={{animationDelay: '0.4s', animationFillMode: 'both'}}>
            ...
            <div className="mt-8 animate-fade-in" style={{animationDelay: '0.5s', animationFillMode: 'both'}}>
              <p className="text-base text-gray-300">Nossa equipe é apaixonada por tecnologia, educação financeira e inovação. Estamos sempre ouvindo nossos usuários para evoluir a plataforma e entregar a melhor experiência possível.</p>
            </div>
          </div>
        </div>
        <div className="mt-16 text-center animate-fade-in" style={{animationDelay: '0.6s', animationFillMode: 'both'}}>
          <h2 className="text-2xl font-bold mb-2 text-primary animate-slide-up">Junte-se ao PontoFino!</h2>
          <p className="text-gray-200">Transforme sua relação com o dinheiro e alcance seus objetivos financeiros de forma leve, moderna e inteligente.</p>
        </div>
      </main>
      <Footer />
    </div>
