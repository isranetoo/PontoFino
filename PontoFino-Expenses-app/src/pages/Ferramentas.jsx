  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-blue-900 to-[#0096fd]">
      ...
      <div className="container mx-auto px-4 py-12 min-h-[60vh] flex-1 w-full">
        <h1 className="text-4xl font-bold text-center mb-10 text-primary">Ferramentas da Plataforma</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-background rounded-lg p-8 shadow-md flex flex-col items-center">
